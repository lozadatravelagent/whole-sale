...
# Accept VITE_ build-time variables from Railway (must be ARG→ENV for Docker builds)
...
ARG VITE_DELFOS_SEARCH_ENABLED
...
ENV VITE_SUPABASE_URL=$VITE_SUPABASE_URL \
    ...
    VITE_DELFOS_SEARCH_ENABLED=$VITE_DELFOS_SEARCH_ENABLED
