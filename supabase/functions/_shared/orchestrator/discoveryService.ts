/**
 * Discovery Service (backend port)
 *
 * NOTE: Backend port of src/features/chat/services/discoveryService.ts. Logic
 * is identical; only imports were redirected to ./types.ts and
 * ./conversationOrchestrator.ts.
 */

import type { ParsedTravelRequest } from './types.ts';
import type { ChatRecommendedPlace } from './conversationOrchestrator.ts';
import { formatDiscoveryResponse } from './conversationOrchestrator.ts';
