...
export function AboutUs() {
  return (
    <section id="about" className="scroll-mt-28 md:scroll-mt-32 py-20 md:py-24 bg-transparent relative overflow-hidden">
      <div className="absolute inset-0 landing-section-scrim" />
