...
const REGION_ALIASES: Record<string, string> = {
  ...
  'europa principales': 'europe_classic',
  'principales ciudades de europa': 'europe_classic',
  asia: 'asia_highlights',
  'asia principales': 'asia_highlights',
  'principales ciudades de asia': 'asia_highlights',
  'sudeste asiatico': 'southeast_asia',
  'sudeste asiático': 'southeast_asia',
  'southeast asia': 'southeast_asia',
  sudamerica: 'south_america',
  sudamérica: 'south_america',
  'america del sur': 'south_america',
  'américa del sur': 'south_america',
  'south america': 'south_america',
  norteamerica: 'north_america',
  norteamérica: 'north_america',
  'america del norte': 'north_america',
  'américa del norte': 'north_america',
  'north america': 'north_america',
  centroamerica: 'central_america',
  centroamérica: 'central_america',
  'america central': 'central_america',
  'américa central': 'central_america',
  'central america': 'central_america',
  africa: 'africa_highlights',
  áfrica: 'africa_highlights',
  oceania: 'oceania_highlights',
  oceanía: 'oceania_highlights',
  'medio oriente': 'middle_east',
  'middle east': 'middle_east',
  'europa del este': 'europe_east',
  'europa oriental': 'europe_east',
  'europa este': 'europe_east',
  'este de europa': 'europe_east',
  'eastern europe': 'europe_east',
  'europe east': 'europe_east',
  'europa del norte': 'scandinavia',
  ...
  'islas del caribe': 'caribbean_mix',
  'playas del caribe': 'caribbean_mix',
  'caribe principales': 'caribbean_mix',
  'principales ciudades del caribe': 'caribbean_mix',
};
