...
/**
 * CITY_MAPPINGS - Diccionario de códigos de ciudades
 */
...
export function resolveAirportCode(
    ...
    if (fallbackCode.length === 3) {
        ...
        console.warn(`⚠️ [ACTION REQUIRED] Add "${cityName}" to CITY_MAPPINGS in cityCodeResolver.ts`);
